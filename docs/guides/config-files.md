...
|---------|---------|---------|---------|-----------|
| `AGNES_PROVIDER` | Primary [LLM provider](/docs/getting-started/providers) | "anthropic", "openai", etc. | None | Yes |
...
| `AGNES_TELEMETRY_ENABLED` | Enable [anonymous usage data](/docs/guides/usage-data) collection | true/false | false | No |
...
AGNES_MODEL: "claude-4.5-sonnet"
AGNES_TEMPERATURE: 0.7

# Planning Configuration
AGNES_PLANNER_PROVIDER: "openai"
AGNES_PLANNER_MODEL: "gpt-4"

# Tool Configuration
AGNES_MODE: "smart_approve"
AGNES_TOOLSHIM: true
