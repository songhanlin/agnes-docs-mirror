...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Discover features you can use to share information and communicate with agnes during sessions."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      title="6 Essential Tips for Working with agnes"
      ...
      link="/blog/2025/03/06/agnes-tips"
    />
    <Card
    ...
    <Card
      ...
      description="Learn how context windows, tokens, and agnes help you manage memory and long conversations."
