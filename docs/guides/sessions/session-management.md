...
<Tabs groupId="interface">
    ...
    <TabItem value="cli" label="Agnes CLI">
        ...
        In the output above, `20260213_9` is the session ID. Session IDs use the format `YYYYMMDD_<COUNT>`. Many [Agnes CLI commands](/docs/guides/goose-cli-commands) let you identify a session by name (`--name` / `-n`) as an alternative to `--session-id`.
    </TabItem>
</Tabs>
