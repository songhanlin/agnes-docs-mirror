...
1. Local filesystem:
   - Current directory
   - Directories specified in [`AGNES_RECIPE_PATH`](/docs/guides/environment-variables#recipe-configuration) environment variable
   
2. GitHub repositories:
   - Configure using [`AGNES_RECIPE_GITHUB_REPO`](/docs/guides/environment-variables#recipe-configuration) configuration key
...
- `AGNES_RECIPE_RETRY_TIMEOUT_SECONDS`: Global timeout for success check commands
- `AGNES_RECIPE_ON_FAILURE_TIMEOUT_SECONDS`: Global timeout for on_failure commands
