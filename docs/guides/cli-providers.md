...
|---------------------|-------------|---------|
| `AGNES_PROVIDER` | Set to `claude-code` to use this provider | None |
| `AGNES_MODEL` | Model to use (only `sonnet` or `opus` are passed to CLI) | `claude-sonnet-4-20250514` |
| `CLAUDE_CODE_COMMAND` | Path to the Claude CLI command | `claude` |

**Known Models:**

The following models are recognized and passed to the Claude CLI via the `--model` flag. If `AGNES_MODEL` is set to a value not in this list, no model flag is passed and Claude Code uses its default:
...
| Environment Variable | Description | Default |
|---------------------|-------------|---------|
| `AGNES_PROVIDER` | Set to `cursor-agent` to use this provider | None |
...
| Environment Variable | Description | Default |
|---------------------|-------------|---------|
| `AGNES_PROVIDER` | Set to `codex` to use this provider | None |
| `AGNES_MODEL` | Model to use (only known models are passed to CLI) | `gpt-5.2-codex` |
...
The following models are recognized and passed to the Codex CLI via the `-m` flag. If `AGNES_MODEL` is set to a value not in this list, no model flag is passed and Codex uses its default:
...
| Environment Variable | Description | Default |
|---------------------|-------------|---------|
| `AGNES_PROVIDER` | Set to `gemini-cli` to use this provider | None |
