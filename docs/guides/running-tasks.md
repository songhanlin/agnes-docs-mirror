...
When working with the Agnes CLI, you can pass files and instructions to the `goose run` command to execute tasks and workflows. This could be a simple one-liner command or a complex set of instructions stored in a file.
...
There are multiple ways to run tasks with Agnes; check out the [list of options](/docs/guides/goose-cli-commands.md#run-options).
